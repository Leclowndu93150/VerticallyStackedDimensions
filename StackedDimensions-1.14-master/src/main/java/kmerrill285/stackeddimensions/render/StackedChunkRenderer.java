...
//	    		}
		...
		if (StackedDimensions.ticks > 0) {
			...
			if (StackedDimensions.loadingChunks == false) {
				StackedDimensions.loadingChunks = true;
...
//											StackedDimensions.renderWorld.getChunk(X, Z) instanceof EmptyChunk) {
